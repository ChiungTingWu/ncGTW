...
#'
#' This function calculates the p-value of each peak group in the with the
#' smaller "bw" parameter, and finds the corresponding peak group in the with
#' the larger "bw" parameter.
#' @param xcmsLargeWin A  object with a larger bw, usually the maximum expected
#'   retension time drift.
#' @param ncGTWinput A object with a smaller bw, usually the resolution of the
#'   retension time.
#' @param ncGTWoutput A  object with a larger bw, usually the maximum expected
#'   retension time drift.
#' @param ppm A object with a smaller bw, usually the resolution of the
#'   retension time.
